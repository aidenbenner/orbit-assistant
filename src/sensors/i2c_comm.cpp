...
void i2c_write_to_reg (uint8_t i2c_add, uint8_t reg,  uint8_t *data, 
    uint8_t length)
{
  boosted_wire.beginTransmission (i2c_add);  
...
void i2c_write_to_reg (uint8_t i2c_add, uint8_t reg,  uint8_t val){
  i2c_write_to_reg(i2c_add,reg,&val,1);
}


void i2c_read (uint8_t i2c_add, uint8_t *buffer, uint8_t length)
{
  boosted_wire.beginTransmission (i2c_add);  
  for (int i = 0; i < length; i++)
  {
...
void i2c_read_from_reg (uint8_t i2c_add, uint8_t reg, uint8_t *buffer,
    uint8_t length)
{
